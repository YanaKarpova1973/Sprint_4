...
class TestBooksCollector:
    ...
    @pytest.mark.parametrize('book_name',['Книга джунглей'] )
    def test_add_new_book_addition_result(self, book_name):
    ...
    def test_set_book_genre_get_genre(self, set_genre):
        ...
        assert  set_genre in collector.get_book_genre(set_book)
    ...
    def test_get_books_with_specific_genre_horror(self, three_books):
        assert  'Кристина', 'Сияние' in three_books.get_books_with_specific_genre('Ужасы')
